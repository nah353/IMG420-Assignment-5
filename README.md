...
The raycast detection continuously draws a visual line that stops when colliding with anything, and specifically triggers the alarm function when that collision is the player. Laser color changes to red and plays an alarm sound effect when said player is detected.
